...
namespace Gothic_I_Classic {
  ...
  class zCPatchMap;
  enum zTAICamMsg : int;
  enum zTMatIDList : int;
  enum zTAnimationMode : int;
  enum zELogTopicStatus : int;
  enum zELogSection : int;
  enum TMobInterDirection : int;
  enum TMobMsgSubType : int;
  enum TDamageSubType : int;
  enum TWeaponSubType : int;
  enum TMovementSubType : int;
  enum TAttackSubType : int;
  enum TUseItemSubType : int;
  enum TStateSubType : int;
  enum TManipulateSubType : int;
  enum TConversationSubType : int;
  enum TConversationSubType : int;
  enum zTPortalType : int;
  enum zTWayPoint : int;
  enum zTSurfaceAlignMode : int;
  enum zTMovementState : int;
  enum zTArchiveMedium : int;
  enum zTAccessMode : int;
  enum zEOctreeChild : int;
  enum zTSpanningMode : int;
  enum zTCSPlayResult : int;
  enum TCutsceneSubType : int;
  enum zTCSRoleFlag : int;
  enum zTCSCheckResult : int;
  enum zTCSRunBehaviour : int;
  enum zEConfigState : int;
  enum zTCSCam_EvSubType : int;
  enum zTCSCam_ActivateSubType : int;
  enum zTCamTrj_FOR : int;
  enum zTCamTrj_LoopMode : int;
  enum zCOLLECT_MODE : int;
  enum zTFileSourceType : int;
  enum zTEventMusicControlerSubType : int;
  enum zTCamAlign : int;
  enum zTTexAniType : int;
  enum zTCamLocationHint : int;
  enum zTLoopType : int;
  enum zTSpeakerType : int;
  enum zTSndManMedium : int;
  enum zTOperatingSystem : int;
  enum zTCpuType : int;
  enum zTTexFileDesiredBPP : int;
  enum zTThread_Prio : int;
  enum LOCK_FLAGS : int;
  enum LOCK_FLAGS : int;
  enum zTCalcVertNormalMode : int;
  enum zTTimeBehavior : int;
  enum zTEventCoreSubType : int;
  enum zTVobCharClass : int;
  enum zTMovementMode : int;
  enum zTDynShadowType : int;
  enum zTEventCommonSubType : int;
  enum zTEventMoverSubType : int;
  enum zTMoverState : int;
  enum zTMoverAniType : int;
  enum zTMoverBehavior : int;
  enum zTTouchBehavior : int;
  enum zTPosLerpType : int;
  enum zTSpeedType : int;
  enum zTListProcess : int;
  enum zTDamageCollType : int;
  enum zTEventScreenFXSubType : int;
  enum zTMessageType : int;
  enum zTWorldLoadMode : int;
  enum zTWorldSaveMode : int;
  enum zTWorldLoadMergeMode : int;
  enum zTStaticWorldLightMode : int;
  enum zTSoundVolType : int;
  enum zTSoundMode : int;
  enum zTWld_RenderMode : int;
  enum zTRnd_ScreenMode : int;
  enum zTInfoMgrMode : int;
  enum TFAction : int;
  enum zETradeDialogSection : int;
  enum zEHeading : int;
  enum zTViewFX : int;
  enum zTViewFX : int;
  enum zTViewAlign : int;
  enum zTVisualCamAlign : int;
  enum zTPMLightingMode : int;
